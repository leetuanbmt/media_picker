...
final class Gap extends StatelessWidget {
  const Gap.h(double width, {super.key, double? height, this.color})
    : _width = width,
      _height = height;

  const Gap.v(double height, {super.key, double? width, this.color})
    : _width = width,
      _height = height;
...
class SliverGap extends StatelessWidget {
  const SliverGap.h(double width, {super.key, double? height, this.color})
    : _width = width,
      _height = height;

  const SliverGap.v(double height, {super.key, double? width, this.color})
    : _width = width,
      _height = height;
