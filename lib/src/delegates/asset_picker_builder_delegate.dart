...
abstract class AssetPickerBuilderDelegate<Asset, Path> {
  ...
  Widget selectedBackdrop(BuildContext context, int index, Asset asset);
  ...
  Widget audioItemBuilder(BuildContext context, int index, Asset asset);

  Widget imageAndVideoItemBuilder(BuildContext context, int index, Asset asset);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        color: theme.primaryColor.withValues(
          alpha: isAppleOS(context) ? 0.90 : 1,
        ),
        child: Row(
          children: <Widget>[
  ...
  Widget bottomActionBar(BuildContext context) {
    final children = <Widget>[
      ...
      Container(
        ...
        color: theme.bottomAppBarTheme.color?.withValues(
          alpha:
              theme.bottomAppBarTheme.color!.a * (isAppleOS(context) ? .9 : 1),
        ),
        child: Row(
          children: <Widget>[
    ...
    Widget child = Column(mainAxisSize: MainAxisSize.min, children: children);
...
class DefaultAssetPickerBuilderDelegate
      ...
      if (updateIds.isNotEmpty && createIds.isEmpty && deleteIds.isEmpty) {
        await Future.wait(
          updateIds.map((id) async {
            ...
            if (i != -1) {
              final asset = await provider.currentAssets[i]
                ...
                child: Selector<DefaultAssetPickerProvider, List<AssetEntity>>(
                  ...
                  builder: (BuildContext context, List<AssetEntity> assets, _) {
                    ...
                    return CustomScrollView(
                      ...
                      anchor: anchor,
                      center: gridRevert && !onlyOneScreen
                          ? gridRevertKey
                          : null,
                      slivers: <Widget>[
                        if (isAppleOS(context))
  ...
  Widget assetGridItemBuilder(
    ...
    final DefaultAssetPickerProvider p = context
        .read<DefaultAssetPickerProvider>();
    ...
    final Widget builder = switch (asset.type) {
      AssetType.image ||
      AssetType.video => imageAndVideoItemBuilder(context, currentIndex, asset),
    ...
    final Widget content = Stack(
      ...
      children: <Widget>[
        ...
        if (!isPreview || asset.type != AssetType.video)
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: ScaleText(
          ...
          semanticsLabel:
              '${semanticsTextDelegate.sNameDurationLabel}: '
              '${semanticsTextDelegate.durationIndicatorBuilder(Duration(seconds: asset.duration))}',
        ),
      ),
    );
  }
      ...
      progressBuilder: (context, state, progress) => Row(
        ...
        children: [
          Icon(
            ...
            color: context.iconTheme.color?.withValues(alpha: .4),
            size: 24.0,
          ),
          ...
          children: <Widget>[
            ValueListenableBuilder<PermissionState>(
              ...
              builder: (_, PermissionState ps, Widget? child) => Semantics(
                label:
                    '${semanticsTextDelegate.viewingLimitedAssetsTip}, '
              ...
              child: Padding(
                ...
                child: Text.rich(
                  TextSpan(
                    children: <TextSpan>[
                      TextSpan(text: textDelegate.viewingLimitedAssetsTip),
                      TextSpan(
                        text:
                            ' '
  ...
  @override
  Widget pathEntitySelector(BuildContext context) {
    Widget pathText(BuildContext context, String text, String semanticsText) {
      return Flexible(
        child: ScaleText(
          text,
            ...
            Expanded(
              child: Padding(
                ...
                child: ScaleText(
                  ...
                  maxLines: 1,
                  maxScaleFactor: 1.2,
                  semanticsLabel: semanticsTextDelegate
    ...
    final children = <Widget>[
      ...
      if (hasBottomActions)
        Container(
          ...
          color: theme.bottomAppBarTheme.color?.withValues(
            alpha:
                theme.bottomAppBarTheme.color!.a *
